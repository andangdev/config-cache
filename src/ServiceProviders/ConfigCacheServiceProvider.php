...
namespace Ugiw\ConfigCache\ServiceProviders;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Arr;
use Ugiw\ConfigCache\ConfigCache;
use Ugiw\ConfigCache\Exceptions\InvalidConfiguration;
...
class ConfigCacheServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                \Ugiw\ConfigCache\Commands\ConfigCacheCommand::class,
            ]);
        }
    }
